  ...
  return (
    <>
      {/* {sendByMe ? ( */}
        <>
          <div
            aria-selected={sendByMe}
            className={`${css.msg}`}
            // className='flex flex-col px-4 py-0.5 my-1 self-end gap-1 max-w-[80%]'
          >
            ...
            <span className='flex self-end px-4 py-0.5 rounded-md bg-blue-500 text-zinc-900'>
              {msg?.body}
            </span>
          </div>
      ...
      {/* ) : (
        <div className='flex flex-col px-4 py-0.5 my-1  self-start gap-1 max-w-[80%]'>
          ...
          <span className='flex self-start  px-4 py-0.5 rounded-md  bg-zinc-600 text-zinc-100'>
            {msg?.body}
          </span>
        </div>
      )} */}
